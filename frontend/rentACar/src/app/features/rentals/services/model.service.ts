...
import { CreatedModelDto } from '../models/modelModels/createdModelDto';
import { DeletedModelDto } from '../models/modelModels/deletedModelDto';
import { Injectable } from '@angular/core';
import { ListResponseModel } from './../../../core/models/listResponseModel';
import { Model } from '../models/modelModels/model';
import { ModelListModel } from '../models/modelModels/modelListModel';
import { Observable } from 'rxjs';
import { UpdatedModelDto } from '../models/modelModels/updatedModelDto';
...
export class ModelService {
  ...
  add(model: Model): Observable<CreatedModelDto> {
    return this.httpClient.post<CreatedModelDto>(
  ...
  update(model: Model): Observable<UpdatedModelDto> {
    return this.httpClient.put<UpdatedModelDto>(
      `${this.apiControllerUrl}`,
      model
      );
  }
  ...
  delete(model: Model): Observable<DeletedModelDto> {
    return this.httpClient.delete<DeletedModelDto>(
      `${this.apiControllerUrl}`,
       { body: model })
       ;
  }
