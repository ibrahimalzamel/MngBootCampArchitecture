...
(function (undefined) {
    ...
    ************************************/
    ...
    extend(Locale.prototype, {
        ...
        _months : 'Ocak_Åžubat_Mart_Nisan_MayÄ±s_Haziran_Temmuz_AÄŸustos_EylÃ¼l_Ekim_KasÄ±m_AralÄ±k'.split('_'),
        months : function (m) {
            return this._months[m.month()];
        },

        _monthsShort : 'Oca_Åžub_Mar_Nis_May_Haz_Tem_AÄŸu_Eyl_Eki_Kas_Ara'.split('_'),
        ...
        _weekdays : 'Pazar_Pazartesi_SalÄ±_Ã‡arÅŸamba_PerÅŸembe_Cuma_Cumartesi'.split('_'),
        weekdays : function (m) {
            return this._weekdays[m.day()];
        },

        _weekdaysShort : 'Pzr_Pzt_SalÄ±_Ã‡rÅŸ_PrÅŸ_Cuma_Cmt'.split('_'),
        weekdaysShort : function (m) {
            return this._weekdaysShort[m.day()];
        },

        _weekdaysMin : 'Pzr_Pzt_SalÄ±_Ã‡rÅŸ_PrÅŸ_Cuma_Cmt'.split('_'),
...
(function (factory) {
    ...
    return moment.defineLocale('en-au', {
        ...
        weekdaysShort : 'Pzr_Pzt_SalÄ±_Ã‡rÅŸ_PrÅŸ_Cuma_Cmt'.split('_'),
        weekdaysMin : 'Pzr_Pzt_SalÄ±_Ã‡rÅŸ_PrÅŸ_Cuma_Cmt'.split('_'),
        longDateFormat : {
            LT : 'h:mm A',
            LTS : 'h:mm:ss A',
            L : 'DD/MM/YYYY',
...
(function (factory) {
    ...
    return moment.defineLocale('en-ca', {
        months : 'Ocak_Åžubat_Mart_Nisan_MayÄ±s_Haziran_Temmuz_AÄŸustos_EylÃ¼l_Ekim_KasÄ±m_AralÄ±k'.split('_'),
        monthsShort : 'Oca_Åžub_Mar_Nis_May_Haz_Tem_AÄŸu_Eyl_Eki_Kas_Ara'.split('_'),
        weekdays : 'Pazartesi_SalÄ±_Ã‡arÅŸamba_PerÅŸembe_Cuma_Cumartesi_Pazar'.split('_'),
        weekdaysShort : 'Pzt_SalÄ±_Ã‡rÅŸ_PrÅŸ_Cuma_Cmt_Pzr'.split('_'),
        weekdaysMin : 'Pzt_SalÄ±_Ã‡rÅŸ_PrÅŸ_Cuma_Cmt_Pzr'.split('_'),
        longDateFormat : {
            LT : 'h:mm A',
            LTS : 'h:mm:ss A',
            L : 'YYYY-MM-DD',
